...
const Driver = () => {
  ...
  const deleteUser = async (user: any = null) => {
    await axios.delete(`${config.API_BASE_URL}/drivers/${user.driver_id}`);
  ...
  const validationSchema = Yup.object().shape({
    ...
    drivingLicenseExpiryDate: Yup.string().required(
      "Driving License Expiry Date is required"
    ),
    truckNumber: Yup.string().required("Truck Number is required"),
    // status: Yup.string().required(' Status is required'),
    truckExpiryDate: Yup.string().required(
      "Truck Expiry Date Tones is required"
    ),
    // whatsappNumber: Yup.string().required('Whatsapp Number is required'),
    whatsappNumber: Yup.number()
      .typeError("whatsapp number must be a number")
      .positive("whatsapp number must be a positive number")
      .integer("whatsapp number must be an integer")
      ...
      try {
        if (params.driver_id) {
          const response = await axios.put(
            `${config.API_BASE_URL}/drivers/${params.driver_id}`,
            values
          );
  ...
  const addDriver = async (user: any = null) => {
  ...
  const updateDriverStatus = async (
    ...
    const response = await axios.put(
      `${config.API_BASE_URL}/drivers/${driver_id}`,
      { status }
    );
  ...
  return (
    <div>
      <div className="flex items-center justify-between flex-wrap gap-4">
        <h2 className="text-xl">Driver</h2>
                        ...
                        <div className="flex gap-4 items-center justify-center">
                          <button
                            ...
                            className={`btn btn-sm btn-outline-primary ${
                              contact?.status === "Active" ? "btn-outline-danger" : "btn-outline-primary"
                            }`}
                            onClick={() =>
                              updateDriverStatus(
                                contact?.driver_id,
                          ...
                          >
                            {contact?.status === "Active" ? "Block" : "Active"}
                          </button>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                      ...
                      <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            disabled={viewMode}
                            defaultValue={moment(
                              formik?.values?.truckExpiryDate
                            ).format("YYYY-MM-DD")}
                            required
                          />
                          {formik.touched.truckExpiryDate &&
                            formik.errors.truckExpiryDate && (
                              <div className="text-red-500 text-sm">
                                {formik.errors.truckExpiryDate}
                              </div>
                            )}
                      ...
                      <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            required
                            defaultValue={moment(
                              formik?.values?.idCardExpiryDate
                            ).format("YYYY-MM-DD")}
                          />

                          {formik.touched.idCardExpiryDate &&
                            formik.errors.idCardExpiryDate && (
                              <div className="text-red-500 text-sm">
                                {formik.errors.idCardExpiryDate}
                              </div>
                            )}
                      ...
                      <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            required
                          />
                          {formik.touched.drivingLicenseNumber &&
                            formik.errors.drivingLicenseNumber && (
                              <div className="text-red-500 text-sm">
                                {formik.errors.drivingLicenseNumber}
                              </div>
                            )}
                        ...
                        <div>
                          <label htmlFor="drivingLicenseExpiryDate">
                          ...
                          <input
                            ...
                            disabled={viewMode}
                            defaultValue={moment(
                              formik?.values?.drivingLicenseExpiryDate
                            ).format("YYYY-MM-DD")}
                            required
                          />
                          {formik.touched.drivingLicenseExpiryDate &&
                            formik.errors.drivingLicenseExpiryDate && (
                              <div className="text-red-500 text-sm">
                                {formik.errors.drivingLicenseExpiryDate}
                              </div>
                            )}
                      ...
                      {/* <div className="mt-4">
                                                ...
                                                <input
                                                    ...
                                                    className="form-input"
                                                    disabled={viewMode}
                                                    defaultValue={moment(formik?.values?.drivingLicenseExpiryDate).format('YYYY-MM-DD')}
                                                    required
                                                />
                      ...
                      {/* <div className="mt-4">
                                                <label htmlFor="drivingLicenseExpiryDate">Passport Expiry Date</label>
                                                <input
                                                    ...
                                                    className="form-input"
                                                    disabled={viewMode}
                                                    defaultValue={moment(formik?.values?.passportExpiryDate).format('YYYY-MM-DD')}
                                                    required
                                                />
                                                {formik.touched.passportExpiryDate && formik.errors.passportExpiryDate && (
                                                    <div className="text-red-500 text-sm">{formik.errors.passportExpiryDate}</div>
                                                )}
                                            </div> */}
                      <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                      ...
                      <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            disabled={viewMode}
                          />
                          {formik.touched.truck_document &&
                            formik.errors.truck_document && (
                              <div className="text-red-500 text-sm">
                                {formik.errors.truck_document}
                              </div>
                            )}
