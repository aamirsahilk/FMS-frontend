                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('FMS')}</span>
                        </NavLink>
                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'forms' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/setting/componey">{t('Company')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/setting/user">{t('User')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/setting/email">{t('Email')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/setting/role">{t('Role')}</NavLink>
                                        </li>

                                        <li>
                                            <NavLink to="/setting/companyassign">{t('Assign Company ')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            {/* location */}
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'location' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('location')}>
                                    <div className="flex items-center">
                                        <IconMenuPages className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Location')}</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'location' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/location/country">{t('Country')}</NavLink>
                                        </li>
                                       
                                        <li>
                                            <NavLink to="/location/state">{t('State')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/location/city">{t('City')}</NavLink>
                                        </li>  

                                         <li>
                                            <NavLink to="/location/border">{t('Border')}</NavLink>
                                        </li> 
                                        <li>
                                            <NavLink to="/location/route">{t('Route')}</NavLink>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'customer' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/customer/customer">{t('Customer')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            {/* Client */}
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'receiver' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('receiver')}>
                                    <div className="flex items-center">
                                        <IconMenuPages className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Receiver')}</span>
                                    </div>

                                    <div className={currentMenu !== 'receiver' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'receiver' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/client/client">{t('Receiver')}</NavLink>
                                        </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'vehicle' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/vehicle/truck">{t('Truck')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/vehicle/driver">{t('Driver')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'booking' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('booking')}>
                                    <div className="flex items-center">
                                        <IconMenuPages className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Booking')}</span>
                                    </div>

                                    <div className={currentMenu !== 'booking' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'booking' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/booking/booking">{t('Booking')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/booking/filterinvoice">{t('List Of Invoice')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'transaction' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('transaction')}>
                                    ...
                                    <div className={currentMenu !== 'transaction' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'transaction' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/transaction/transaction">{t('Transaction')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/transaction/invoice">{t('Invoice Receipt')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            {/* tracking */}
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'tracking' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('tracking')}>
                                    <div className="flex items-center">
                                        <IconMenuPages className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Tracking')}</span>
                                    </div>

                                    <div className={currentMenu !== 'tracking' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'tracking' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/tracking/stages">{t('Tracking Stages')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/tracking/tracking">{t('Tracking')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'report' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        {/* <li>
                                            <NavLink to="/report/location">{t('Country Report')}</NavLink>
                                        </li> */}
                                        <li>
                                            <NavLink to="/report/Routereport">{t('Route Report')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/report/customerbooking">{t('Customer Booking Report')}</NavLink>
                                        </li>
                                        {/* <li>
                                            <NavLink to="/report/customerreciept">{t('Customer Reciept Report')}</NavLink>
                                        </li> */}
                                        {/* <li>
                                            <NavLink to="/report/customerinvoice">{t('Customer Invoice Report')}</NavLink>
                                        </li> */}
                                        <li>
                                            <NavLink to="/report/driverbooking">{t('Driver Booking Report')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/users/RouteBorder">{t('Route Border')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/users/UpdateDocuments">{t('Update Documents')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/users/Customers">{t('Customers')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/users/Client">{t('Client')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/users/Driver">{t('Driver')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li> */}
